...
$error = isset($_GET['error']) && $_GET['error'] == 1 ? $json['order_form']['error_text'] : "";
?>
<!DOCTYPE html>
<html lang="uk">
<head>
...
<body class="font-sans bg-gray-50 text-gray-900">
    ...
    <section class="hero-bg h-screen flex items-center text-white">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <h1 class="text-5xl md:text-7xl font-bold leading-none mb-6 tracking-tighter"><?= $json['hero']['h1'] ?></h1>
    ...
    <?= json_encode([
        ...
        "aggregateRating" => ["@type" => "AggregateRating", "ratingValue" => $json['schema']['ratingValue'], "reviewCount" => $json['schema']['reviewCount']],
